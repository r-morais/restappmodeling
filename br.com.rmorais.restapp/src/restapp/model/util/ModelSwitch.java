...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelPackage.PRICE: {
				Price price = (Price)theEObject;
				T result = casePrice(price);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.PURCHASE: {
				Purchase purchase = (Purchase)theEObject;
				T result = casePurchase(purchase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.PROVIDER: {
				Provider provider = (Provider)theEObject;
				T result = caseProvider(provider);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.PRODUCTS_PURCHASE: {
				ProductsPurchase productsPurchase = (ProductsPurchase)theEObject;
				T result = caseProductsPurchase(productsPurchase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.PHYSICAL_CARD: {
				PhysicalCard physicalCard = (PhysicalCard)theEObject;
				T result = casePhysicalCard(physicalCard);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ModelPackage.PRODUCTS_CARD: {
				ProductsCard productsCard = (ProductsCard)theEObject;
				T result = caseProductsCard(productsCard);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Products Purchase</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Products Purchase</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProductsPurchase(ProductsPurchase object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Physical Card</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Physical Card</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePhysicalCard(PhysicalCard object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Products Card</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Products Card</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProductsCard(ProductsCard object) {
		return null;
	}
